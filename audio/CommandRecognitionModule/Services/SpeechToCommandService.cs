...
public class SpeechToCommandService : SpeechToCommand.SpeechToCommandBase
{
    ...
    {
        _logger = logger;
		iamToken = "t1.9euelZrIyYqdkpXKm8bOj5OblpqXj-3rnpWamM2dy5eVz8aMx8-NncqKzZ3l8_ceVTVN-e9Xekpn_d3z914DM03571d6Smf9zef1656VmpeVl8aTlYyPjMiZzY2YzIuV7_zF656VmpeVl8aTlYyPjMiZzY2YzIuV.iZag2k_Y9-G9X4ub9-ujIQ23Ftn_EFvYHEw6x5eQRtZ7nYktSJQGqeqr4lSuEhROoVRm0zBMDMElbgCAYV5oBA";
        _yandexSttClient = new YandexSttClient(iamToken, new Uri("https://stt.api.cloud.yandex.net:443"), "b1gv6ij7c6frub5g0dk2");
        ...
        ServerCallContext context)
    {
        ...
        while (true)
        {
			...
			try	
			{
				...
				Console.WriteLine("Exception during read final refirement from yandex stt. You should write something to request stream of CRM to recreate stream to YSTT");
			}
