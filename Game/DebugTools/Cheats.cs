...
public static class Cheats
{
	...
	private static DevPanel.Menu currentMenu;
	...
	public static DevPanel.Menu ShowMenu()
	{
		if (currentMenu != null) {
			return currentMenu;
		}

		var menu = new DevPanel.Menu(The.World, Layers.CheatsMenu);
	...
	private static void InitialFill(DevPanel.Menu menu)
	{
...
#endif // PROFILER
#if !WEB && !MAC
		Extensions.RemoteScriptingClientExtension.FillDebugMenuItems(menu);
#endif
	}
