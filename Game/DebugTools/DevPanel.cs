...
public class Helper {
    ...
    public static void DecorateButton(Button b, Color4 bgColor, Color4? textColor = null) {
        ...
        b.DefaultAnimation.Markers.Add(new Marker("Normal", 0, MarkerAction.Stop));
        aBg.Keys.Add(0, bgColor);
        b.DefaultAnimation.Markers.Add(new Marker("Focus", 10, MarkerAction.Stop));
        aBg.Keys.Add(10, bgColor);
        b.DefaultAnimation.Markers.Add(new Marker("Press", 20, MarkerAction.Stop));
        aBg.Keys.Add(20, bgColor);
        b.DefaultAnimation.Markers.Add(new Marker("Disable", 30, MarkerAction.Stop));
...
public class Menu {
    ...
    public Section Section(string text) {
        ...
        Helper.DecorateButton(
            foldButton, NiceColors.AccentColor(nextColorIndex),
            NiceColors.DarkTextColor(nextColorIndex)
        );
